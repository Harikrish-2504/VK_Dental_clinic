                        ...
                        <form className="flex flex-col gap-6">
                            <div className="flex flex-col">
                                ...
                                <input
                                    type="email"
                                    placeholder=""
                                    className="border-0 border-b-2 border-[#bc641c] text-[#fff] focus:outline-none focus:ring-0 transition"
                                />
                            </div>
                            ...
                            <div className="flex flex-col">
                                ...
                                <input
                                    type="password"
                                    placeholder=""
                                    className="border-0 border-b-2 border-[#ff7c25] text-[#fff] focus:outline-none focus:ring-0 transition"
                                />
                            </div>
                            <div className="mb-8 ">
                                <button
