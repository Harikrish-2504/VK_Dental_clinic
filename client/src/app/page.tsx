  ...
  return initialLoading ? (
    ...
    <>
      ...
      <section className="bg-[#eff9eb] py-20" id="about">
        <div className="container">
          <div className="">
            <h1 className="text-[#595858] lg:text-4xl md:text-2xl text-xl font-semibold mb-5 md:mb-15">
              About Us
            </h1>
          </div>
          <div className="flex flex-col lg:flex-row  gap-15 items-center justify-center">
            ...
            <p className="max-w-[640px] lg:tracking-wide font-medium lg:text-xl md:text-lg text-md md:leading-9 leading-6">
              ...
              pressure. Drs. Patel, Conkey, and Moberger are dedicated to
              helping you maintain optimal oral health to keep you healthy and
              happy as you possibly can be.Lorem ipsum dolor sit amet,
                  ...
                  <div className="flex flex-col md:gap-4 gap-2 items-start ">
                    <button className="font-medium text-sm md:text-lg text-[#070B00]">
                      ...
                      <a
                        ...
                        className={`hover:text-[#E68120] ${
                          activeSection === "home" ? "text-[#E68120] " : ""
                        }`}
                      >
                        Home
                      </a>
                    ...
                    <button className="font-medium text-sm md:text-lg text-[#070B00]">
                      ...
                      <a
                        href="#service"
                        className={`hover:text-[#E68120] ${
                          activeSection === "service" ? "text-[#E68120] " : ""
                        }`}
                      >
                        Services
                      </a>
                    ...
                    <button className="font-medium text-sm md:text-lg text-[#070B00]">
                      ...
                      <a
                        href="#about"
                        className={`hover:text-[#E68120] ${
                          activeSection === "about" ? "text-[#E68120] " : ""
                        }`}
                      >
                        About Us
                      </a>
                    ...
                    <button className="font-medium text-sm md:text-lg text-[#070B00]">
                      ...
                      <a
                        href="/gallery"
                        className={`hover:text-[#E68120] ${
                          activeSection === "gallery" ? "text-[#E68120] " : ""
                        }`}
                      >
                        Services
                      </a>
                    ...
                    <button className="font-medium text-sm md:text-lg text-[#070B00]">
                      ...
                      <a
                        href="contactus"
                        className={`hover:text-[#E68120] ${
                          activeSection === "contactus" ? "text-[#E68120] " : ""
                        }`}
                      >
                        Contact Us
                      </a>
